...
import com.example.demo.mservice.enums.Language;
import com.example.demo.mservice.models.*;
import com.example.demo.mservice.shared.constants.Parameter;
import com.example.demo.mservice.shared.exception.MoMoException;
import com.example.demo.mservice.shared.utils.Encoder;
...
public class BindingToken extends AbstractProcess<BindingTokenRequest, BindingTokenResponse> {
    ...
    public static BindingTokenResponse process(Environment env, String orderId, String requestId,
            String partnerClientId, String callbackToken) {
        try {
            BindingToken m2Processor = new BindingToken(env);

            BindingTokenRequest request = m2Processor.createBindingTokenRequest(orderId, requestId, partnerClientId,
                    callbackToken);
    ...
    public BindingTokenResponse execute(BindingTokenRequest request) throws MoMoException {
        try {
            ...
            BindingTokenResponse BindingTokenResponse = getGson().fromJson(response.getData(),
                    BindingTokenResponse.class);
    ...
    public BindingTokenRequest createBindingTokenRequest(String orderId, String requestId, String partnerClientId,
        ...
        try {
            ...
            return new BindingTokenRequest(partnerInfo.getPartnerCode(), orderId, requestId, Language.EN,
                    partnerClientId, callbackToken, signRequest);
        } catch (Exception e) {
