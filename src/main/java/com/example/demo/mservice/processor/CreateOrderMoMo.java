...
import com.example.demo.mservice.enums.*;
import com.example.demo.mservice.models.HttpResponse;
import com.example.demo.mservice.models.PaymentRequest;
...
public class CreateOrderMoMo extends AbstractProcess<PaymentRequest, PaymentResponse> {
    ...
    public static PaymentResponse process(Environment env, String orderId, String requestId, String amount,
            ...
            com.example.demo.mservice.enums.RequestType requestType, Boolean autoCapture) throws Exception {
        try {
    ...
    public PaymentRequest createPaymentCreationRequest(String orderId, String requestId, String amount,
            ...
            com.example.demo.mservice.enums.RequestType requestType, Boolean autoCapture) {
