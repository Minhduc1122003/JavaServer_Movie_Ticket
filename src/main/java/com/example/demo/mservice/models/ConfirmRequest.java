...
public class ConfirmRequest extends Request {
    ...
    public ConfirmRequest(String partnerCode, String orderId, String requestId, Language lang, Long amount,
            String description, ConfirmRequestType requestType, String signature) {
