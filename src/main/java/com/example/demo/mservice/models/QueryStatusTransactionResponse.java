...
public class QueryStatusTransactionResponse extends Response {
    ...
    public QueryStatusTransactionResponse(String requestId, String metaData,
            List<RefundOfQueryStatusTransaction> refundTrans, Long amount, String partnerUserId, Long transId,
            String extraData, String payType) {
