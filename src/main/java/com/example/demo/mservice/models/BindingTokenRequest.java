...
public class BindingTokenRequest extends Request {
    ...
    public BindingTokenRequest(String partnerCode, String orderId, String requestId, Language lang,
            String partnerClientId, String callbackToken, String signature) {
