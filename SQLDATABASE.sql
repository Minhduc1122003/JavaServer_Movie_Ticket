...
-- ngan viet store: findByViewMovieID
USE [APP_MOVIE_TICKET]
GO
/****** Object:  StoredProcedure [dbo].[GetInsuranceAreaByIdEmployee]    Script Date: 10/8/2024 3:16:15 PM ******/
...
GO
CREATE PROCEDURE [dbo].[findByViewMovieID] (@movieId int = null ,@userId int =null)
AS
BEGIN
SELECT 
    m.MovieID,
